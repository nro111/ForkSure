...
export const FONTS = {
	fontLg: { fontSize: SIZES.fontLg, color: COLORS.text, lineHeight: 20, fontFamily: 'PlusJakartaSansRegular' },
	font: { fontSize: SIZES.font, color: COLORS.text, lineHeight: 20, fontFamily: 'PlusJakartaSansRegular' },
	fontSm: { fontSize: SIZES.fontSm, color: COLORS.text, lineHeight: 18, fontFamily: 'PlusJakartaSansRegular' },
	fontXs: { fontSize: SIZES.fontXs, color: COLORS.text, lineHeight: 14, fontFamily: 'PlusJakartaSansRegular' },
	h1: { fontSize: SIZES.h1, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	h2: { fontSize: SIZES.h2, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	h3: { fontSize: SIZES.h3, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	h4: { fontSize: SIZES.h4, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	h5: { fontSize: SIZES.h5, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	h6: { fontSize: SIZES.h6, color: COLORS.title, fontFamily: 'PlusJakartaSansSemiBold' },
	fontBold: { fontFamily: 'PlusJakartaSansBold' },
	fontMedium: { fontFamily: 'PlusJakartaSansMedium' },
	fontTitle: { fontFamily: 'PlusJakartaSansMedium' },
	fontRegular: { fontFamily: 'PlusJakartaSansRegular' },
	fontSemiBold: { fontFamily: 'PlusJakartaSansSemiBold' },
	fontLight: { fontFamily: 'PlusJakartaSansLight' },
	fontExtraBold: { fontFamily: 'PlusJakartaSansExtraBold' },
}
