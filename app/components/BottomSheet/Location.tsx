...
const LocationSheet = ({LocationRef} : any) => {
        ...
        <View style={[GlobalStyleSheet.container, { paddingTop: 0 }]}>
            ...
            <View style={{ marginTop: 15 }}>
                {LocationData.map((data, index) => {
                    return (
                        <TouchableOpacity
                            onPress={() => setactiveLocation(data)}
                            key={index}
                            style={{
                                flexDirection:'row',
                                alignItems:'center',
