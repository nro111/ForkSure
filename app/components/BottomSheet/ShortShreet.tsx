...
const shortData = [
    ...
    {
        title:"Popularity (e.g., number of applications)"
    },
]
...
const ShortSheet2 = ({shortRef} : Props) => {
    ...
    const [activeSize, setActiveSize] = useState(shortData[0]);
    ...
    return (
        <View style={[GlobalStyleSheet.container, { paddingTop: 0 }]}>
            ...
            >
                <Text style={[FONTS.fontSemiBold, { color: colors.text, fontSize: 16 }]}>Short</Text>
                <TouchableOpacity
