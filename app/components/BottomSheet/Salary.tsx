...
const SalaryData = [
    {
        title:"$150,000 - $400,000+"
    },
    {
        title:"$200,000 - $500,000+"
    },
    {
        title:"$120,000 - $200,000+"
    },
    {
        title:"$110,000 - $180,000+"
    },
    {
...
const SalarySheet = ({SalaryRef} : any) => {

    const theme = useTheme();
    const { colors } : {colors : any} = theme;

    const [activeSalary, setactiveSalary] = useState(SalaryData[0])
    return (
