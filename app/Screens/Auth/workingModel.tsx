...
type WorkingModelScreenProps = StackScreenProps<RootStackParamList, 'workingModel'>;

const WorkingModel = ({navigation} : WorkingModelScreenProps) => {
    ...
    const [jobworkingmodel, setjobworkingmodel] = useState(userData.jobworkingmodel);

    const handlejobworkingmodel = async () => {
        ...
        try {
            ...
            let updateData = {
                jobworkingmodel: jobworkingmodel,
            }
                        ...
                        >
                            ...
                            >
                                <View style={{padding:20,paddingTop:10}}>
                                    <Text style={{...FONTS.fontBold,fontSize:20,color:colors.title,textAlign:'center',paddingHorizontal:10}}>What is your preferred working model?</Text>
                                </View>
                                <ScrollView
                                ...
                                >
                                    <View style={{flex:1}}>
                                        {WorkingData.map((data,index) => {
                                            return(
                                                <TouchableOpacity
                                                    onPress={() => setjobworkingmodel(data)}
                                                    key={index}
                                                    style={[{
                                                        padding:15,
                                                        borderWidth:2,
                                                        ...
                                                        gap:10,
                                                        marginBottom:15
                                                    },jobworkingmodel?.title === data.title && {
