...
type LookingForScreenProps = StackScreenProps<RootStackParamList, 'LookingFor'>;
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={{...FONTS.fontBold,fontSize:14,color:COLORS.card,opacity:.5,lineHeight:18}}>2</Text>
                        </View>
                        <View
                            style={{
                                height:5,
                        ...
                        >
                            ...
                            >
                                <View style={{padding:20,paddingTop:10}}>
                                    <Text style={{...FONTS.fontBold,fontSize:20,color:colors.title,textAlign:'center'}}>Which type of job are you looking for?</Text>
                                </View>
                                <ScrollView
