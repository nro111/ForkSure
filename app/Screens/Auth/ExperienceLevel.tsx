import { View, Text, SafeAreaView, TouchableOpacity,ActivityIndicator, ToastAndroid } from 'react-native'
...
type ExperienceLevelScreenProps = StackScreenProps<RootStackParamList, 'ExperienceLevel'>;

const ExperienceLevel = ({navigation} : ExperienceLevelScreenProps) => {
    ...
    const [jobExperienceLevel, setjobExperienceLevel] = useState(userData.jobExperienceLevel);

    const handlejobExperienceLevel = async () => {
        ...
        <SafeAreaView style={[GlobalStyleSheet.container,{padding:0,flex:1}]}>
            ...
            >
                ...
                >
                    ...
                    >
                       ...
                       <View 
                        ...
                        >
                            <Text style={{...FONTS.fontBold,fontSize:14,color:COLORS.card,opacity:.5,lineHeight:18}}>3</Text>
                        </View>
                        <View
                            style={{
                                height:5,
                        ...
                        >
                            <Text style={{...FONTS.fontBold,fontSize:14,color:COLORS.card,opacity:.5,lineHeight:18}}>4</Text>
                        </View>
                    </View>
                </View>
                <View style={{flex:1}}>
                        ...
                        >
                            ...
                            >
                                <View style={{padding:20,paddingTop:10}}>
                                    <Text style={{...FONTS.fontBold,fontSize:20,color:colors.title,textAlign:'center'}}>What is your current experience level?</Text>
                                </View>
                                <ScrollView
                                ...
                                >
                                    <View style={{flex:1}}>
                                        {ExperienceData.map((data,index) => {
                                            return(
                                                <TouchableOpacity
                                                    onPress={() => setjobExperienceLevel(data)}
                                                    key={index}
                                                    style={[{
                                                        padding:15,
                                                        borderWidth:2,
                                                        ...
                                                        gap:10,
                                                        marginBottom:15
                                                    },jobExperienceLevel?.title === data.title && {
                ...
                <View style={{paddingHorizontal:15,paddingBottom:10}}>
                    <Button
                        title={'Next'}
                        onPress={handlejobExperienceLevel}
